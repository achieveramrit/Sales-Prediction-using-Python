...
Model Development:Initialized and fitted a LinearRegression model using scikit-learn.

Performance Evaluation:Generated target predictions on the test set and evaluated accuracy using Mean Absolute Error (MAE) and the R-squared ($R^2$) metric.
